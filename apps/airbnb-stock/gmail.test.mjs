...
test("collector filters untrusted mail and always closes IMAP", async () => {
  ...
  const client = {
    ...
    async *fetch() {
      yield { uid: 1, internalDate: new Date("2026-08-18T12:00:00Z"), envelope: { subject: "Sixty60 invoice for order 218300001", from: [{ address: "no-reply@checkers.sixty60.co.za" }] } };
