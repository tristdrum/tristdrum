...
- Bag drop is always welcome after the previous guest has actually checked out, normally from 10:00 and later if that guest departs late. It is luggage storage only and does not grant room access before cleaning readiness is confirmed.
