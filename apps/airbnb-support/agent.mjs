      ...
      input: [
        {
          ...
          content: [{
            ...
            text: [
              ...
              "When replyRouteAvailable is false and a reply is needed, keep a useful guest draft but set sendReply false and alertManagement true. Your managementSummary must explain the actual question/action and that the reply needs to be sent in Airbnb because an email reply route is unavailable. This is not a reason to alert about messages needing no reply.",
