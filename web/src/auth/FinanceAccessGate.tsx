...
const financeArea: AccessArea = {
  eyebrow: 'Finance access',
  title: 'Finance hub',
  setupDescription: 'The finance schema or household access helpers are not available yet. Apply the finance migration, provision household membership, then retry.',
}

export default function FinanceAccessGate({
  children,
  area = financeArea,
}: {
  children: ReactNode
    ...
    return (
      <main className="private-shell">
        <section className="private-panel private-panel--centered">
          <p className="private-eyebrow">{area.eyebrow}</p>
          <h1>Checking household membership…</h1>
          <p className="private-copy">Private household data stays restricted to active household members.</p>
        </section>
      </main>
    )
  }
    ...
    return (
      <main className="private-shell">
        <section className="private-panel private-panel--centered">
          ...
          <h1>{area.title}</h1>
          <p className="private-copy">{area.setupDescription}</p>
